...
public class DossiersManager  extends ActionSupport implements SessionAware{
	...
	public String execute() throws Exception {
		init();
		List<Dossier> ld = bean.getAllDossiersFromJournalist((Journaliste)session.get("journaliste"));
		session.put("mesDossiers", ld);
		return SUCCESS;
	}
