...
public class ValidatorDossiersManager  extends ActionSupport implements SessionAware{
	...
	public String execute() throws Exception {
		init();
		List<Dossier> ld = bean.getAllNonValidatedDossiers();
		session.put("lesDossiers", ld);
		return SUCCESS;
	}
